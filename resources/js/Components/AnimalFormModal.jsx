            ...
            <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl flex flex-col overflow-hidden">
                ...
                <div className="bg-teal-600 px-6 py-4 flex justify-between items-center">
                    <h2 className="text-lg font-black text-white flex items-center gap-2">
                        <i className="fa-solid fa-paw"></i> Registrar Nuevo
                        Animal
                    </h2>
                    <button
                        onClick={onClose}
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-teal-400 text-slate-600"
                            />
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-teal-400"
                                placeholder="Ruta o enlace a la imagen"
                            />
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                name="food_ration"
                                required
                                value={formData.food_ration}
                                onChange={handleChange}
                                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-teal-400"
                                placeholder="Ej: 5kg carne / 3 veces al día"
                            />
                        </div>
                        ...
                        <div className="space-y-1 md:col-span-2">
                            ...
                            <textarea
                                ...
                                placeholder="Información relevante para visitantes o cuidadores..."
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 flex gap-3">
                        <button
                            type="submit"
                            className="flex-1 bg-teal-600 hover:bg-teal-700 text-white px-4 py-3.5 rounded-xl text-sm font-black shadow-md transition-colors flex justify-center items-center gap-2"
                        >
