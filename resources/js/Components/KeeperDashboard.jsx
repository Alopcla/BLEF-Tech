...
export default function KeeperDashboard() {
    ...
    const stats = useMemo(() => {
        const fed = animals.filter((a) => a.last_fed_date === today).length;
        const pending = animals.length - fed;
        return { fed, pending, total: animals.length };
    }, [animals, today]);
