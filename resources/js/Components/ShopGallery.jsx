                ...
                <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[40px] bg-[#0f1f0f] border border-[#2a4a2a] shadow-[0_30px_80px_rgba(0,0,0,0.8)]">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-10 py-10 gap-6">
                        <div>
                            ...
                            <h1
                                className="fuente-zoo text-5xl md:text-7xl text-white leading-tight"
            ...
            <div className="max-w-7xl mx-auto px-4 pb-32 flex flex-col lg:flex-row gap-8">
                ...
                <aside className="w-full lg:w-64 flex-shrink-0">
                    <div className="sticky top-6 bg-[#111811]/90 backdrop-blur-md rounded-[28px] border border-neutral-800 p-6 flex flex-col gap-6">
                        ...
                        {/* Buscador */}
                        <div>
                            <p className="text-[#E0D7B6] text-xs font-bold uppercase tracking-widest mb-3">
                                Buscar
                            </p>
                            <div className="relative">
                                <i className="bi bi-search absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 text-sm"></i>
                                <input
                                    type="text"
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-1">
                                {CATEGORIAS.map(cat => (
                                    ...
                                    >
                                        <i className={`bi ${ICONOS[cat]} text-base`}></i>
                                        {cat}
                                        {cat !== 'Todos' && (
                        ...
                        {(busqueda || filtroCategoria !== 'Todos') && (
                            ...
                            >
                                <i className="bi bi-x-circle mr-2"></i>Limpiar filtros
                            </button>
                        )}
                    </div>
                </aside>
                ...
                <main className="flex-1">
                    ...
                    {cargando ? (
                        ...
                        <div className="text-center py-32">
                            <i className="bi bi-bag-x text-6xl text-neutral-700 mb-4 block"></i>
