...
<body class="relative font-sans">
    ...
    <header class="flex justify-center items-center mt-10 px-6">
        <div class="flex items-center gap-10 bg-black/40 backdrop-blur-md px-6 py-4 rounded-2xl shadow-lg">
            ...
            <nav class="hidden md:flex gap-8 text-[#D9C8A1] text-xl">
                ...
                <a href="#" class="hover:bg-[#D9C8A1] hover:text-[#3A6B35] px-4 py-2 rounded-full transition">Tickets</a>
                <a href="{{route('VistaExperiencias')}}" class="hover:bg-[#D9C8A1] hover:text-[#3A6B35] px-4 py-2 rounded-full transition">Experiencias</a>
                <a href="#" class="hover:bg-[#D9C8A1] hover:text-[#3A6B35] px-4 py-2 rounded-full transition">Contacto</a>
            </nav>
    ...
    <section class="max-w-6xl mx-auto mt-16 px-5 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        @foreach($experiencias as $exp)
            ...
            <div class="bg-black/70 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-[#D9C8A1]/30 hover:-translate-y-2 hover:shadow-2xl transition duration-300">
                ...
                <div class="p-6">
                    ...
                    <button class="w-full bg-[#D9C8A1] text-[#3A6B35] py-2 rounded-full hover:bg-[#3A6B35] hover:text-[#D9C8A1] transition">
                        Reservar
                    </button>
