...
<head>
    ...
    <title>Maintenance Panel - Zoo</title>
...
<body class="p-10 bg-blue-50">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md border-t-4 border-blue-500">
            ...
            <p class="text-gray-600 mb-6">Bienvenido, Mantenimiento. Aquí gestionaremos las diferentes tareas a realizar para el mantenimiento del zoológico.</p>
